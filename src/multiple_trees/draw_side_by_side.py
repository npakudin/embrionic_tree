...
from src.view.draw_compared_trees import TreeDrawer, FERTILITY_DRAW_SETTINGS, DEBUG_DRAW_SETTINGS
...
def draw_trees(param_a, is_reducing, folder):
    ...
    treeDrawer = TreeDrawer(FERTILITY_DRAW_SETTINGS, global_params)
    #treeDrawer = TreeDrawer(DEBUG_DRAW_SETTINGS, global_params)
    for i in range(0, len(trees)):
        ...
        for j in range(len(trees)):
            ...
            treeDrawer.draw_tree(trees[i], trees[j], folder)
